...
class Txt extends StatelessWidget {
  ...
  TextStyle? _baseStyle(BuildContext context) {
    switch (baseStyle) {
      ...
      case TxtStyle.bodyText1:
        return Theme.of(context).primaryTextTheme.bodyLarge;
      case TxtStyle.bodyText2:
        return Theme.of(context).primaryTextTheme.bodyMedium;
      case TxtStyle.caption:
        return Theme.of(context).primaryTextTheme.bodySmall;
  ...
  Widget build(BuildContext context) {
    final TextStyle? usingStyle =
        baseStyle != TxtStyle.none ? _baseStyle(context)!.merge(style) : style;
