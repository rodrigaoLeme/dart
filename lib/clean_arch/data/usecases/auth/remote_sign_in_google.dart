...
/// Implementação do caso de uso do SignInGoogle
class RemoteSignInGoogle implements SignInGoogle {
  final AuthRepository repository;

  RemoteSignInGoogle({required this.repository});

  @override
  Future<UserEntity> call() async {
    try {
      final firebaseUser = await repository.signInWithGoogle();
